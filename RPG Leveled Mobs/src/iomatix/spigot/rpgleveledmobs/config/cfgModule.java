	    ...
	    private void convertOldConfig() {
	        ...
	        for (final String world : enabledWorlds) {
	            ...
	            if (tempWorld != null) {
	                ...
	                for (final String nodeKey : oldConfig.getConfig().getConfigurationSection(world + ".spawnLocations").getKeys(false)) {
	                	LogsModule.debug("World: " + world + " - Found SpawnPoint: " + nodeKey + " - Loading Configuration!");
	                    final String tag = world + ".spawnLocations." + nodeKey;
	                    final SpawnNode node = wc.addSpawnNode(oldConfig.getConfig().getDouble(tag + ".x", 0.0), oldConfig.getConfig().getDouble(tag + ".y", 0.0), oldConfig.getConfig().getDouble(tag + ".z", 0.0));
	                    if (oldConfig.getConfig().contains(tag + ".LevelNameFormat")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found LevelNameFormat, saving setting!");
	                    ...
	                    if (oldConfig.getConfig().contains(tag + ".startLevel")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found StartLevel, saving setting!");
	                        node.setStartLevel(oldConfig.getConfig().getInt(tag + ".startLevel"));
	                    }
	                    if (oldConfig.getConfig().contains(tag + ". UsePrefix")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found UsePrefix, saving setting!");
	                        node.setPrefixEnabled(oldConfig.getConfig().getBoolean(tag + ".UsePrefix"));
	                    }
	                    if (oldConfig.getConfig().contains(tag + ".UseSuffix")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found UseSuffix, saving setting!");
	                    ...
	                    if (oldConfig.getConfig().contains(tag + ".DamageModifierEnabled")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found DamageModifierEnabled, saving setting!");
	                    ...
	                    if (oldConfig.getConfig().contains(tag + ".DefenseModifierEnabled")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found DefenseModifierEnabled, saving setting!");
	                    ...
	                    if (oldConfig.getConfig().contains(tag + ".MobArenaWaveLeveling")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found MobArenaWaveLeveling, saving setting!");
	                    ...
	                    if (oldConfig.getConfig().contains(tag + ".DistancePerLevel")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found DistancePerLevel, saving setting!");
	                        node.setDistancePerLevel(oldConfig.getConfig().getDouble(tag + ".DistancePerLevel"));
	                    }
	                    if (oldConfig.getConfig().contains(tag + ".MaxLevel")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found MaxLevel, saving setting!");
	                        node.setMaxLevel(oldConfig.getConfig().getInt(tag + ".MaxLevel"));
	                    }
	                    if (oldConfig.getConfig().contains(tag + ".ExperienceModifier")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found ExperienceModifier, saving setting!");
	                    ...
	                    if (oldConfig.getConfig().contains(tag + ".HealthMultiplier")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found HealthMultiplier, saving setting!");
	                    ...
	                    if (oldConfig.getConfig().contains(tag + ".DamageMultiplier")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found DamageMultiplier, saving setting!");
	                    ...
	                    if (oldConfig.getConfig().contains(tag + ".DefenseMultiplier")) {
	                    	LogsModule.debug("World: " + world + " - SpawnNode: " + nodeKey + " - Found DefenseMultiplier, saving setting!");
